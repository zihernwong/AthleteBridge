...
struct ClientFormView: View {
    ...
    private let availableGoals: [String] = ClientFormView.sharedGoalsAndSpecialties
    ...
    private let availableSpecialties: [String] = ClientFormView.sharedGoalsAndSpecialties
